...
class ParserTest {
    ...
    fun calculateReferencesTest() {
        ...
        assertEquals(expected, parser.calculateReferences(input))
    }
    ...
    fun generateASTTest() {
        ...
        assertEquals(expected, parser.generateAST(input, 0 ).first)
    ...
    fun parseASTTest() {
        ...
        var expected = 2.0
        assertEquals(expected, parser.parseAST(input), 0.01)
